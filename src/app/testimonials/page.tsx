              ...
              >
                {testimonials.map((testimonial) => (
                  <motion.div
                    ...
                    transition={{ duration: 0.6 }}
                    viewport={{ once: true, amount: 0.2 }}
                    className="flex flex-col  border border-gray-200 rounded-2xl overflow-hidden shadow-md hover:shadow-xl hover:border-brand-green-500 transition-all duration-300 h-full p-6 bg-white"
                  >
                    {/* Stars */}
