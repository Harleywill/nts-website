...
export const metadata = {
  title: "Projects - NTS Ltd",
  description: "Explore our completed projects and case studies showcasing our expertise in HVAC and mechanical services.",
};
        ...
        <section className="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              We're currently building our comprehensive project portfolio. Check back soon to see our latest completed projects and case studies.
            </p>
            <a
              href="/"
