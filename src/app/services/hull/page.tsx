      ...
      <main className="flex-grow">
        ...
        <section className="relative isolate overflow-hidden bg-gradient-to-b from-gray-900 to-gray-800 px-6 pt-24 pb-24 sm:py-32 lg:px-8 min-h-[400px] flex items-center">
          <div className="mx-auto max-w-4xl">
            ...
            >
              <p className="text-brand-green-400 font-semibold mb-2 flex items-center justify-center gap-2">
              ...
              {[
                ...
                >
                  <div className="flex items-start gap-4">
                    <FaCheckCircle className="text-brand-green-600 flex-shrink-0 mt-1 text-xl" />
                    <div>
