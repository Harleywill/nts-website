      ...
      {projects.length === 0 ? (
        <BoldPanel cornerBrackets>
          <div className="py-12 text-center">
            <p className="text-adm-textMut text-sm font-mono mb-4">No projects found</p>
            <Link href="/admin/projects/new">
              <BoldButton variant="secondary" size="md">
                + New Project
              </BoldButton>
              ...
              <tbody className="divide-y divide-adm-border/50">
                {projects.map((item: any) => (
                  <tr key={item.id} className="hover:bg-adm-panelAlt/30 transition-colors">
                    ...
                    <td className="px-4 py-3 text-adm-textBody">{item.category}</td>
                    ...
                    <td className="px-4 py-3 text-right space-x-2">
                      ...
                      <DeleteButton id={item.id} type="project" name={item.title} />
                    </td>
                  </tr>
                ))}
              </tbody>
