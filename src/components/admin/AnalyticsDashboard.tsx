    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={fetchAnalytics}
          disabled={loading}
          className="px-4 py-2 bg-brand-green-500 text-white rounded-lg hover:bg-brand-green-600 disabled:opacity-50 transition-colors flex items-center gap-2"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <p className="text-4xl font-bold text-brand-green-600 mt-2">{data.realTimeUsers}</p>
          ...
          {data.pageViews.trend.map((day, index) => {
            ...
            return (
              <div key={index} className="flex-1 flex flex-col items-center gap-2">
                <div
                  className="w-full bg-gradient-to-t from-brand-green-500 to-green-400 rounded-t"
                  style={{ height: `${height}%` }}
          ...
          <div className="space-y-4">
            {data.topPages.map((page, index) => (
              <div key={index} className="flex items-start gap-4">
                <div className="flex-shrink-0 w-8 h-8 bg-brand-green-100 rounded-full flex items-center justify-center">
