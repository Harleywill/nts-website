...
const statusColors: Record<Status, { bg: string; text: string }> = {
  NEW: { bg: 'bg-brand-green-100', text: 'text-brand-green-900' },
  ...
  HIRED: { bg: 'bg-brand-green-100', text: 'text-brand-green-900' },
  REJECTED: { bg: 'bg-gray-100', text: 'text-gray-700' },
  DRAFT: { bg: 'bg-gray-100', text: 'text-gray-700' },
  PUBLISHED: { bg: 'bg-brand-green-100', text: 'text-brand-green-900' },
